...
export default function AISupport() {
  ...
  const quickSuggestions = [
    { icon: '💰', text: 'Pricing', query: 'What are your service prices?' },
    { icon: '🚨', text: 'Emergency', query: 'I need emergency help now!' },
    { icon: '📋', text: 'Book Service', query: 'How do I book a service?' },
    { icon: '📍', text: 'Track Order', query: 'How to track my mechanic?' }
  ]
  ...
  useEffect(() => {
    ...
    styleSheet.textContent = `
      ...
      @keyframes pulse { 
        0%, 100% { box-shadow: 0 8px 24px rgba(74, 158, 255, 0.4); } 
        50% { box-shadow: 0 12px 32px rgba(74, 158, 255, 0.6); } 
      }
      @keyframes glow {
    ...
    return (
      <button
        ...
        onMouseEnter={(e) => {
          ...
          e.target.style.boxShadow = '0 12px 32px rgba(74, 158, 255, 0.6)'
        }}
        onMouseLeave={(e) => {
          e.target.style.transform = 'scale(1)'
          e.target.style.boxShadow = '0 8px 24px rgba(74, 158, 255, 0.4)'
        }}
      >
        🤖
      </button>
  ...
  return (
    <div className="ai-support-modal" style={{
      ...
      boxShadow: '0 20px 60px rgba(0,0,0,0.5), 0 0 40px rgba(74, 158, 255, 0.15)',
      display: 'flex',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#fff' }}>
          ...
          <div>
            <h3 style={{ margin: '0', fontSize: '18px', fontWeight: '800', letterSpacing: '0.3px' }}>RepairWale AI</h3>
            <p style={{ margin: '0', fontSize: '12px', opacity: 0.95, fontWeight: '500' }}>Always here to help • 24/7</p>
          </div>
        </div>
        <button
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: msg.role === 'user' 
                  ? 'linear-gradient(135deg, #4A9EFF 0%, #60A5FF 100%)' 
                  : 'linear-gradient(135deg, #0F1728 0%, #162844 100%)',
                border: `1px solid ${msg.role === 'user' ? 'rgba(74, 158, 255, 0.5)' : '#2A4368'}`,
                color: '#E6EDF7',
                fontSize: '14px',
                lineHeight: '1.6',
                  ...
                  {msg.buttons.map((button, idx) => (
                    <button
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.target.style.boxShadow = '0 4px 16px rgba(74, 158, 255, 0.4)'
                      }}
                      onMouseLeave={(e) => {
                ...
                <div style={{
                  ...
                  {followUpSuggestions.map((suggestion, idx) => (
                    <button
                      ...
                      onMouseLeave={(e) => {
                        e.target.style.background = 'rgba(15, 23, 40, 0.8)'
                        e.target.style.borderColor = '#2A4368'
      ...
      <div style={{
        padding: '16px 20px',
        borderTop: '2px solid #2A4368',
        display: 'flex',
        gap: '10px',
        background: 'linear-gradient(135deg, #0F1728 0%, #0B1220 100%)',
        flexShrink: 0,
        ...
        <input
          ...
          onFocus={(e) => {
            e.target.style.borderColor = '#4A9EFF'
            e.target.style.boxShadow = '0 0 0 4px rgba(74, 158, 255, 0.15)'
          }}
          onBlur={(e) => {
            e.target.style.borderColor = '#2A4368'
            e.target.style.boxShadow = 'none'
        ...
        <button
          ...
          onMouseEnter={(e) => { 
            if (input.trim() && !isLoading) {
              e.target.style.transform = 'translateY(-2px)'
              e.target.style.boxShadow = '0 6px 24px rgba(74, 158, 255, 0.4)'
            }
          }}
          onMouseLeave={(e) => { 
            if (input.trim() && !isLoading) {
